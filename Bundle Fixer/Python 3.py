"""
This code is from 'https://pastebin.com/Qde67sKx'.
"""

"""
This changes the bundle metadata back to the way it used to be, so the Bundle Modder will access the files just fine again.
Also, the game will fall back to the old format (all_xy_h.bundle) if it cannot find the new format (all_h.bundle).
Just a hunch I had but it worked out fine.
 
More precisely:
 
1. I move the all_h.bundle file to the location of the script, possibly overwriting it if it already exists there.
...
2. I read in the all_h.bundle and use the info to create individual all_xy_h.bundle.
